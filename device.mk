...
LOCAL_KERNEL := device/nvidia/shieldtablet-kernel/Image.gz-dtb
else
...
LOCAL_FSTAB := $(LOCAL_PATH)/initfiles/fstab.tn8
...
PRODUCT_COPY_FILES := \
    ...
    $(LOCAL_PATH)/initfiles/init.tn8.usb.rc:root/init.tn8.usb.rc \
    $(LOCAL_PATH)/initfiles/init.recovery.tn8.rc:root/init.recovery.tn8.rc \
    $(LOCAL_FSTAB):root/fstab.tn8 \
    $(LOCAL_PATH)/initfiles/ueventd.tn8.rc:root/ueventd.tn8.rc
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/bluetooth/bcmdhd.cal:system/etc/wifi/bcmdhd.cal \
    $(LOCAL_PATH)/bluetooth/bcmdhd_lte.cal:system/etc/wifi/bcmdhd_lte.cal
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/gps/qct/lib_vendor/libmdmdetect.so:system/vendor/lib/libmdmdetect.so \
    $(LOCAL_PATH)/gps/qct/lib_vendor/libperipheral_client.so:system/vendor/lib/libperipheral_client.so

# NFC feature + config files
PRODUCT_COPY_FILES += \
    frameworks/native/data/etc/android.hardware.nfc.xml:system/etc/permissions/android.hardware.nfc.xml \
    frameworks/native/data/etc/android.hardware.nfc.hce.xml:system/etc/permissions/android.hardware.nfc.hce.xml \
    device/nvidia/shieldtablet/nfc/libnfc-brcm.conf:system/etc/libnfc-brcm.conf \
    device/nvidia/shieldtablet/nfc/libnfc-brcm-20795a10.conf:system/etc/libnfc-brcm-20795a10.conf
...
#$(call inherit-product-if-exists, vendor/htc/shieldtablet/device-vendor.mk)
$(call inherit-product-if-exists, hardware/broadcom/wlan/bcmdhd/firmware/bcm4354/device-bcm.mk)
#$(call inherit-product-if-exists, vendor/htc/shieldtablet/audio/lifevibes/lvve/device-vendor-lvve.mk)
#$(call inherit-product-if-exists, vendor/htc/shieldtablet/audio/tfa/device-vendor-tfa.mk)
